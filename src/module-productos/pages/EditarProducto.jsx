...
export const EditarProducto = () => {
  ...
  const initialValues = {
    ...
    numero_folio_producto: producto?.numero_folio_producto,
    ...
    cantidad_minima_stock: producto?.cantidad_minima_stock,
    cantidad_maxima_stock: producto?.cantidad_maxima_stock,
  };
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={6}>
                      <Field
                        ...
                        helperText={
                          <ErrorMessage name="numero_folio_producto" />
                        }
                      />
                    </Grid>
                    <Grid item xs={12} md={6}>
                      <Field
                        ...
                        helperText={
                          <ErrorMessage name="precio_compra_producto" />
                        }
                      />
                    </Grid>
                    ...
                    <Grid item xs={12} md={6}>
                      <Field
                        ...
                        helperText={
                          <ErrorMessage name="precio_venta_producto" />
                        }
                      />
                    </Grid>
                    <Grid item xs={12} md={6}>
                    ...
                    <Grid item xs={12} md={6}>
                      <Field
                        ...
                        helperText={
                          <ErrorMessage name="cantidad_minima_stock" />
                        }
                      />
                    </Grid>
                    <Grid item xs={12} md={6}>
                      <Field
                        ...
                        helperText={
                          <ErrorMessage name="cantidad_maxima_stock" />
                        }
                      />
                    </Grid>
                    <Grid item xs={12} md={12}>
